...
<div class="container">
  <!-- Content here -->
  <h3 class="presentaciones">Configurar <span style="color:brown;">En vivo</span></h3>


  <form action="procesarConfig.php" method="post" >
      <label id="label-txt" for="url-1" >Ingresar el codigo </label>
      <textarea name="url_1" id="iframe"  rows="7" class="form-control">

      </textarea>
      
      <label id="label-txt" for="titulo" >Titulo del LIVE</label>
      <input type="text" name="titulo" class="form-control">
     
      <label id="label-txt" for="descripcion" >Descripción del LIVE</label>
