...
<div class="container">
  <!-- Content here -->
  <h3 class="presentaciones">Subir Video a <span style="color:brown;">Galeria</span></h3>


  <form action="procesar_subida.php" method="post" >
      <label id="label-txt" for="url-1" >Ingresar codigo iframe </label>
      <textarea type="text" name="iframe_code" id="iframe"  rows="5" class="form-control">

      </textarea>
      
      <label id="label-txt" for="titulo" >Titulo del VIDEO</label>
      <input type="text" name="titulo" class="form-control">
     
      <label id="label-txt" for="descripcion" >Descripción del VIDEO</label>
